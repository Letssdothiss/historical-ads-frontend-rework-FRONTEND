...
import { DigiFooter, DigiFooterCard, DigiLogo } from '@designsystem-se/af-react'
import {
  FooterVariation,
  FooterCardVariation,
  LogoColor,
  ...
  return (
    <DigiFooter afVariation={FooterVariation.LARGE}>
      <div slot="content-top" className="footer-content-top">
        <div className="footer-content-top__cards">
          ...
          <div>
            <DigiFooterCard>
              <ul>
                <li>
                  <a href="https://arbetsformedlingen.se/om-oss/press">
                    För press och media
                  </a>
                </li>
                <li>
                  <a href="https://arbetsformedlingen.se/varden">
                    För hälso- och sjukvården
                  </a>
                </li>
                <li>
                  <a href="https://arbetsformedlingen.se/for-kommuner">
                    För kommuner
                  </a>
                </li>
              </ul>
        ...
        <div className="footer-card-border-container">
          <DigiFooterCard afType={FooterCardVariation.BORDER}>
            <a href="https://arbetsformedlingen.se/for-arbetsgivare">
              För Arbetsgivare
            </a>
            <p>
          ...
          <DigiFooterCard afType={FooterCardVariation.BORDER}>
            <a href="https://arbetsformedlingen.se/for-leverantorer">
              För Leverantörer
            </a>
          ...
          <DigiFooterCard afType={FooterCardVariation.BORDER}>
            <a href="https://arbetsformedlingen.se/statistik">
              Statistik och analyser
            </a>
            <p>
              När du vill se statistik och ta del av våra analyser för
              arbetsmarknaden
            </p>
          </DigiFooterCard>
        </div>
      ...
      <div slot="content-bottom-right">
        ...
        <a href="https://www.linkedin.com/company/arbetsformedlingen">
          Linkedin
        </a>
